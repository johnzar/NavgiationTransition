...
android {
    ...
    defaultConfig {
        applicationId = "com.johnzar.navigationtransition"
        minSdkVersion(23)
        targetSdkVersion(30)
        versionCode = 2
        versionName = "2.0.0"
...
dependencies {
    ...
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-rx3:1.5.0-native-mt")
...
/*    debugImplementation("com.squareup.leakcanary:leakcanary-android:2.4")*/
    ...
    // Stark
    implementation("com.github.anthonystark1977:mvi:4.0.3")
